...
class NoteService @javax.inject.Inject() (
  ...
  def getForSeq(creds: Credentials, models: Seq[(String, String)])(implicit trace: TraceData) = {
  ...
  def countByAuthor(creds: Credentials, author: UUID)(implicit trace: TraceData) = traceF("count.by.author") { td =>
    db.queryF(NoteQueries.CountByAuthor(author))(td)
  }
  def getByAuthor(
    creds: Credentials, author: UUID, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None
  )(implicit trace: TraceData) = traceF("get.by.author") { td =>
    db.queryF(NoteQueries.GetByAuthor(author, orderBys, limit, offset))(td)
  }
  ...
  def countByCreated(creds: Credentials, created: LocalDateTime)(implicit trace: TraceData) = traceF("count.by.created") { td =>
    db.queryF(NoteQueries.CountByCreated(created))(td)
  }
  def getByCreated(
    creds: Credentials, created: LocalDateTime, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None
  )(implicit trace: TraceData) = traceF("get.by.created") { td =>
    db.queryF(NoteQueries.GetByCreated(created, orderBys, limit, offset))(td)
  }
  ...
  def countById(creds: Credentials, id: UUID)(implicit trace: TraceData) = traceF("count.by.id") { td =>
    db.queryF(NoteQueries.CountById(id))(td)
  }
  def getById(
    creds: Credentials, id: UUID, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None
  )(implicit trace: TraceData) = traceF("get.by.id") { td =>
    db.queryF(NoteQueries.GetById(id, orderBys, limit, offset))(td)
  }
  ...
  def countByRelPk(creds: Credentials, relPk: String)(implicit trace: TraceData) = traceF("count.by.relPk") { td =>
    db.queryF(NoteQueries.CountByRelPk(relPk))(td)
  }
  def getByRelPk(
    creds: Credentials, relPk: String, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None
  )(implicit trace: TraceData) = traceF("get.by.relPk") { td =>
    db.queryF(NoteQueries.GetByRelPk(relPk, orderBys, limit, offset))(td)
  }
  ...
  def countByRelType(creds: Credentials, relType: String)(implicit trace: TraceData) = traceF("count.by.relType") { td =>
    db.queryF(NoteQueries.CountByRelType(relType))(td)
  }
  def getByRelType(
    creds: Credentials, relType: String, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None
  )(implicit trace: TraceData) = traceF("get.by.relType") { td =>
    db.queryF(NoteQueries.GetByRelType(relType, orderBys, limit, offset))(td)
  }
  ...
  def countByText(creds: Credentials, text: String)(implicit trace: TraceData) = traceF("count.by.text") { td =>
    db.queryF(NoteQueries.CountByText(text))(td)
  }
  def getByText(
    creds: Credentials, text: String, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None
  )(implicit trace: TraceData) = traceF("get.by.text") { td =>
    db.queryF(NoteQueries.GetByText(text, orderBys, limit, offset))(td)
  }
