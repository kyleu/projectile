...
import com.kyleu.projectile.models.audit.{AuditField, AuditRecord}
...
object AuditRecordQueries extends BaseQueries[AuditRecord]("auditRecordRow", "audit_record") {
  ...
  override protected def cleanData(any: Any, field: DatabaseField) = any match {
    case _ if field.col == "changes" => any.asInstanceOf[Seq[AuditField]].asJson.spaces2
    case _ => super.cleanData(any, field)
  }
