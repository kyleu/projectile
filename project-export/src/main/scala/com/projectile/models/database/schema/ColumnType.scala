...
object ColumnType extends StringEnum[ColumnType] with StringCirceEnum[ColumnType] {
  ...
  case object DateType extends ColumnType("date", "LocalDate", "DateUtils.fromDateString(xxx)", requiredImport = Some("java.time"))
  case object TimeType extends ColumnType("time", "LocalTime", "DateUtils.fromTimeString(xxx)", requiredImport = Some("java.time"))
  case object TimestampType extends ColumnType("timestamp", "LocalDateTime", "DateUtils.fromIsoString(xxx)", requiredImport = Some("java.time"))
  case object TimestampZonedType extends ColumnType("timestamptz", "ZonedDateTime", "DateUtils.fromIsoStringZoned(xxx)", requiredImport = Some("java.time"))
