...
import models.database.schema.ColumnType.{ArrayType, BigDecimalType, BooleanType, ByteArrayType, ByteType, DateType, DoubleType, EnumType, FloatType, IntegerType, JsonType, LongType, ObjectType, RefType, ShortType, StringType, StructType, TagsType, TimeType, TimestampType, TimestampZonedType, UnknownType, UuidType, XmlType}
import util.Logging

object QueryTranslations extends Logging {
  def forType(i: Int, n: String, colSize: Option[Int] = None, enums: Seq[models.database.schema.EnumType]) = i match {
